-- Fix friendships table with proper foreign key constraints
-- This migration safely handles both cases: table exists with errors or doesn't exist

-- Drop friendships table if it exists (safe cleanup)
DROP TABLE IF EXISTS friendships CASCADE;

-- Recreate friendships table with correct foreign key constraints
